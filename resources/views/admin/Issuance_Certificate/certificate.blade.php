...
<html>
	...
	<body style="border:2px solid black;">
		<div style="float:right; margin-right: 30px; margin-top: 30px;">
			<h5 style="padding: 0px; margin: 5px;">Cert. No. {{$details['certificate_no']}}</h5>
		...
		<div style="text-align: center; position: relative; top: 20px;">
			...
			<h1 style="margin: 0px;"><em><u>{{$details['Name']}}</u></em></h1>
			<h4 style="font-weight: normal; margin:10px;">Date of Birth: {{$details['dob']}}</h4>
			...
			<div>Issued this {{$details['day']}}<sup>th</sup> day of {{$details['month']}} {{$details['year']}} in the City of Manila</div>
		</div>
