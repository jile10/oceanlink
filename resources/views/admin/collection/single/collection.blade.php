...
<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li class="active">Monitor Collection
		</li>
	</ol>
</section>
										...
										@foreach($account as $accounts)
											@if(count($accounts->enrollee)>0)
												...
												<tr>
													...
													<td><form action="/view_accounts/next" method="get"><input type="hidden" name="account_id" value="{{$accounts->id}}"><button class="btn btn-primary"><i class="glyphicon glyphicon-hand-up"></i>&ensp;Select</button></form></td>
												</tr>
												@endif
											@endif
										@endforeach
