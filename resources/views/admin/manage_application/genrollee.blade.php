							...
							<div class="panel panel-primary filterable" style="overflow:auto;">
			                    ...
			                    <div class="panel-body">
				                    ...
				                    <div class="form-group">
				                    	...
				                    	<div class="col-md-6">
				                        	<select onchange="dataChange()" name="org_id" id="org_data" class="form-control" disabled><option selected value="0" disabled>--Choose Organization Name--</option>@foreach($gapp as $gapps)<option value="{{$gapps->id}}">{{$gapps->orgName}}</option>@endforeach</select>
				                        </div>
				                    </div>
									<div class="form-group">
...
@section('js')
    ...
    <script type="text/javascript">
    	...
    	$('#past_data').on('ifUnchecked',function(){
            $("#org_data option[value='0']").attr("disabled", false);
            $('#org_data option:selected').removeAttr('selected');
            $("#org_data option[value='0']").attr("selected", "selected");
