                                    ...
                                    <tbody>
                                        @foreach($tclass as $tclass)
                                            ...
                                            <tr>
                                                ...
                                                <td><form action="/receptionist/manage_enrollment/single/next" method="get"><input type="hidden" name="trainingclass_id" value="{{$tclass->id}}"><button type="submit" class="btn btn-primary">Select</button></form></td>
                                            </tr>
                                            @endif
                                        @endforeach
                                    </tbody>
                                        ...
                                        @foreach($gtclass as $tclasses)
                                            @if(count($tclasses->groupapplicationdetail)>0)
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if($tclasses->groupapplicationdetail->application_status == 1)
                                                            Pending
                                                        @else
                                                            Finalize
                                                        @endif
                                                    </td>
                                                	<td><form action="/receptionist/manage_enrollment/single/next" method="get"><input type="hidden" name="trainingclass_id" value="{{$tclasses->id}}"><button type="submit" class="btn btn-primary">Select</button></form></td>
                                                </tr>
                                            @endif
                                        @endforeach
                                    </tbody>
...
<div class="modal fade in" id="responsive" tabindex="-1" role="dialog" aria-hidden="false" style="display:none;">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form action="/manage_enrollment/group/insert" method="post" class="form-horizontal">
                {{ csrf_field() }}
