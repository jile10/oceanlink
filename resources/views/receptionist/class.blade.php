...
<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li class="active">Training Class</li>
	</ol>
</section>
			...
			<div class="panel panel-success filterable" style="overflow:auto;">
				...
				<div class="panel-body table-responsive">
					<div class="form-group">
						<a href="/receptionist/manage_enrollment/sapplication/" class="btn btn-primary"><i class="glyphicon glyphicon-plus"></i>&ensp;New Individual Application</a>
					</div>
