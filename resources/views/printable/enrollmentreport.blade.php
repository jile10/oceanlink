...
<body>
	...
	<div style="margin-top: 100px;">
		<h2 style="padding: none;">Course : {{$tclass->scheduledprogram->rate->program->programName . ' ('. $tclass->scheduledprogram->rate->duration .' Hours)'}}</h2>
		<h2 style="padding-top: -10px;">Class Name : {{$tclass->class_name}}</h2>
	</div>
	<h3 style="text-align: center;">Enrollment Report</h3>
