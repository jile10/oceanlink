	...
	<table width="100%"  style="border: 1px solid black; border-collapse: collapse;">
		<thead >
			<tr>
				...
				<th width="20%" style="border: 1px solid black; height: 30px; padding-left: 5px;"> Trainee Number</th>
				<th width="45%" style="border: 1px solid black; height: 30px; padding-left: 5px;"> Name</th>
				<th width="15%" style="border: 1px solid black; height: 30px; padding-left: 5px;"> Grade</th>
				<th width="15%" style="border: 1px solid black; height: 30px; padding-left: 5px;"> Remark</th>
			</tr>
		</thead>
		<tbody>
			@if(count($tclass->classdetail)>0)
				@foreach($tclass->classdetail as $details)
					<tr style="border: 1px solid black;">
						...
						<td style="border: 1px solid black; height: 25px;  padding-left: 5px;">{{$details->enrollee->studentNumber}}</td>
						...
						<td style="border: 1px solid black; height: 25px; padding-left: 5px;">{{$details->grade->grade}}</td>
						<td style="border: 1px solid black; height: 25px;  padding-left: 5px;">{{$details->grade->remark}}</td>
					</tr>
				@endforeach
			@else
